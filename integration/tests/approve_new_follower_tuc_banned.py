...
def testFunction(domain_url, session):
	...
	banned_username = "test_user_channel_follower4"
	...
	return performApproveSubscriptionRequestsPermissionChecks(domain_url, session, banned_username, expected_results)
