import string, sets
from api_utils import user_channel_exists, create_user_channel, delete_user_channel, subscribe_to_user_channel, subscribe_to_topic_channel, approve_another_user_channel_subscription_request, approve_another_topic_channel_subscription_request
...
def testFunction(domain_url, session):
	...
	moderator_username = "test_user_channel_moderator"
...
#	delete_user_channel(session, domain_url, api_location, new_follower_username)
