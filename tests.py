...
test_entries.append({'name' : 'api_lookup', 'test' : apiLookup, 'continue_if_fail' : False, 'source' : sources_location + "api_server_lookup.py" })
test_entries.append({'name' : 'api_https_connection', 'test' : apiHTTPSConnection, 'continue_if_fail' : True, 'source' : sources_location + "api_server_connection.py" }) 
test_entries.append({'name' : 'push_server_disco', 'test' : pushServerDisco, 'continue_if_fail' : False, 'source' : sources_location + "push_server_disco.py" })
